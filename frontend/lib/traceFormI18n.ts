...
export const TRACE_FORM_COPY: Record<Lang, TraceFormCopy> = {
  pl: {
    ...
    subject: "Temat",
    subjectPlaceholder: "Wybierz temat obserwacji",
  ...
  en: {
    ...
    lead: "The city reacts to signals. Record what you see.",
    place: "Place",
    placePlaceholder: "e.g. Muranów, stop, courtyard",
    time: "Time",
    timePlaceholder: "e.g. 18:42",
    subject: "Subject",
    subjectPlaceholder: "Select observation subject",
  ...
  it: {
    ...
    subject: "Tema",
    subjectPlaceholder: "Scegli il tema dell'osservazione",
  ...
  lt: {
    ...
    timePlaceholder: "e.g. 18:42",
    subject: "Tema",
    subjectPlaceholder: "Pasirinkite temą",
  ...
  lv: {
    ...
    timePlaceholder: "e.g. 18:42",
    subject: "Temats",
    subjectPlaceholder: "Izvēlieties tematu",
  ...
  hu: {
    ...
    timePlaceholder: "e.g. 18:42",
    subject: "Téma",
    subjectPlaceholder: "Válasszon témát",

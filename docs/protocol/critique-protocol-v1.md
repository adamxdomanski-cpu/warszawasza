...
3. **Minimalny konieczny wysiłek** — cel przy najmniejszym koniecznym wysiłku (poznawczy, obliczeniowy, ludzki); usuń szum i tarcie, które nie służą wynikowi. Szczegóły: [BABCIA OS · Axiom 3](../identity/babcia-os-v1.md).
